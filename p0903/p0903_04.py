...
# # def str_print(n,*v):    #매개변수2개, *v=가변 매개변수-맨 뒤에 배치
# #     for i in range(n):
# #         for j in v:
# #             print(j,end=" ")
# #         print()

# # str_print(3,"hello","nice","bye")


# def str_print(*v,n):   ###n출력 x
#     print(n)

# str_print("hello",1,2,3,4,5)


# def str_print(*v,n):    ###키워드 매개 변수-맨 뒤
#     print(n)

# str_print(1,2,3,4,5,n="hello")
...
# #일반 매개변수, 초기화 매개변수, 가변 매개변수, 키워드 매개변수
